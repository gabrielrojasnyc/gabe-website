...
export function MosaicBackground() {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <div
        className="absolute top-[10%] left-[10%] h-64 w-64 rounded-full bg-rose/10 blur-3xl animate-float-slow"
      />
      <div
        className="absolute bottom-[20%] right-[10%] h-96 w-96 rounded-full bg-rose/5 blur-3xl animate-float-slow-reverse"
      />
    </div>
  )
}
